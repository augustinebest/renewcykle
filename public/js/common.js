...
(function($) {
   ...
   menuAnimation:function()
   {
      ...
      else
      {
          ...
          $(".nim-menu.navbar-default .navbar-nav > li > a").css("color","#000");
 ...
 var fullscreenslider=function()
  {
	...
	delay: 3000,
    slides: [
        { src: "https://www.profeworld.com/images/frontend/images/bak3.jpg" },
        { src: "https://www.profeworld.com/images/frontend/images/bak2.jpg" },
        { src: "https://www.profeworld.com/images/frontend/images/bak3.jpg" },
        { src: "https://www.profeworld.com/images/frontend/images/bak4.jpg" }
    ],animation: 'kenburns'
});
  }